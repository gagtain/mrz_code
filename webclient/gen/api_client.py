...
import webclient.gen.models
from webclient.gen import rest
from webclient.gen.exceptions import ApiValueError, ApiException
...
class ModelSerDe:
    ...
    def sanitize_for_serialization(self, obj):
        ...
        if isinstance(obj, webclient.ext.models.RawResultItem):
            obj_dict = obj.raw
    ...
    def deserialize_raw(self, data, klass):
        ...
        if type(klass) == str:
            ...
            elif hasattr(webclient.ext.models, klass):
                klass = getattr(webclient.ext.models, klass)
            else:
                klass = getattr(webclient.gen.models, klass)
