...
class MrzCodeChecker:
    ...
    def __init__(self, mrz_code: str, **kwargs):
        self.mrz_generate_and_validate = []
        self.mrz_code = mrz_code
        self.set_code_checker()
...
class MrzClass(MrzClassGenerator, MrzCodeChecker):
    """ 
    Класс необходимый для генерации/проверки/получения результатов по данным mrz
    """
    def __init__(self, mrz_code: str, document_type: str, country_code: str, document_number: str, birth_date: str, sex: str, expiry_date: str, nationality: str, surname: str, given_names: str, optional_data1="", optional_data2=""):
        super().__init__(mrz_code, document_type, country_code, document_number, birth_date, sex, expiry_date, nationality, surname, given_names, optional_data1, optional_data2)